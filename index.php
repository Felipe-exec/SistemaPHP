                                ...
                                <div class="p-4">
                                    ...
                                    <form class="user" action="valida_login.php" method="post">
                                        <div class="form-group">
                                            <label> Email </label>
                                            <input type="email" class="form-control form-control-user" id="email" name="email" aria-describedby="emailHelp" placeholder="Endereço de Email..." required>
                                        </div>
                                        <div class="form-group">
                                            <label> Senha </label>
                                    ...
                                    <form class="user mt-2" action="cadastro.php" method="get">
                                        <button type="submit" class="btn btn-user btn-block">
                                            Cadastrar
                                        </button>
                                    </form>
